...
#### Photometric Reasoning
 ...
 - [From Shading to Local Shape](https://arxiv.org/pdf/1310.2916)
 - [Shape, Illumination and Reflectance from Shading](https://arxiv.org/pdf/2010.03592)
 - [Category-Specific Object Reconstruction from a Single Image](https://arxiv.org/pdf/1411.6069)
 - [Deriving intrinsic images from image sequences](http://www.ai.mit.edu/courses/6.899/papers/13_02.PDF)
 - [Recovering Intrinsic Images from a Single Image](https://www.cs.cmu.edu/~efros/courses/AP06/Papers/tappen-nips-02.pdf)
 - [Shapecollage: occlusion-aware, example-based shape interpretation](http://people.csail.mit.edu/billf/publications/Shapecollage_ECCV2012.pdf)
 - [Discriminative Shape from Shading in Uncalibrated Illumination](https://openaccess.thecvf.com/content_cvpr_2015/papers/Richter_Discriminative_Shape_From_2015_CVPR_paper.pdf)
 - [Shape Estimation in Natural Illumination](https://ieeexplore.ieee.org/document/5995510)
 - [Ground truth dataset and baseline evaluations for intrinsic image algorithms](https://www.cs.toronto.edu/~rgrosse/iccv09-intrinsic.pdf)
 - [Intrinsic Images in the Wild](http://labelmaterial.s3.amazonaws.com/release/siggraph2014-intrinsic.pdf)
 - [Learning Ordinal Relationships for Mid-Level Vision](https://people.csail.mit.edu/danielzoran/ordinal.pdf)
 - [CGIntrinsics: Better Intrinsic Image Decomposition through Physically-Based Rendering](https://arxiv.org/pdf/1808.08601)
 - [Single Image Intrinsic Decomposition without a Single Intrinsic Image](https://chuhang.github.io/files/publications/ECCV_18.pdf)
 - [Single-Shot Reflectance Measurement from Polarized Color Gradient Illumination](https://ict.usc.edu/pubs/Single-Shot%20Reflectance%20Measurement%20from%20Polarized%20Color%20Gradient%20Illumination.pdf)
 - [Color Subspaces as Photometric Invariants](http://vision.ucsd.edu/sites/default/files/ColorSubspaces_IJCV_0.pdf)
 - [A Dictionary-based Approach for Estimating Shape and Spatially-Varying Reflectance](https://arxiv.org/pdf/1503.04265)
 - [Near-Light Photometric Stereo using Circularly Placed Point Light Sources](http://www.cs.cmu.edu/~ILIM/projects/IM/nearPS/files/nearPS.pdf)
 - [Deep Outdoor Illumination Estimation](https://arxiv.org/pdf/1611.06403)
 - [Learning to Predict Indoor Illumination from a Single Image](https://arxiv.org/pdf/1704.00090)
 - [Color Constancy by Learning to Predict Chromaticity from Luminance](https://proceedings.neurips.cc/paper/2015/file/9778d5d219c5080b9a6a17bef029331c-Paper.pdf)
 - [Convolutional Color Constancy](https://arxiv.org/pdf/1507.00410)
 - [Illuminant Spectra-based Source Separation Using Flash Photography](https://arxiv.org/pdf/1704.05564)
 - [Learning to Separate Multiple Illuminants in a Single Image](https://arxiv.org/pdf/1811.12481)
 - [Learning Sensor Multiplexing Design through Back-propagation](https://arxiv.org/pdf/1605.07078)
 - [Flash Photography Enhancement via Intrinsic Relighting](https://people.csail.mit.edu/fredo/PUBLI/flash/flash.pdf)
 - [Dark Flash Photography](http://cs.nyu.edu/~fergus/papers/dark_flash.pdf)
 - [Burst Denoising with Kernel Prediction Networks](https://openaccess.thecvf.com/content_cvpr_2018/papers/Mildenhall_Burst_Denoising_With_CVPR_2018_paper.pdf)
 - [Generalized Assorted Pixel Camera: Post-Capture Control of Resolution, Dynamic Range and Spectrum](http://www1.cs.columbia.edu/CAVE/publications/pdfs/Yasuma_IP10.pdf)
 - [Single-Shot High Dynamic Range Imaging with Conventional Camera Hardware](https://ieeexplore.ieee.org/document/6126387)
 - [Unbounded High Dynamic Range Photography using a Modulo Camera](http://web.media.mit.edu/~hangzhao/papers/moduloUHDR.pdf)
 - [A Layer-Based Restoration Framework for Variable-Aperture Photography](https://people.csail.mit.edu/hasinoff/pubs/hasinoff-aperture-2007.pdf)
